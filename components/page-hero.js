  ...
  return (
    <section className="w-full relative h-half md:h-twoThirds">
      <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-full z-20">
        <h1 className="text-light bg-semiTransparentDark lg:text-6xl text-4xl text-center w-screen font-hero text-bold-shadow">
          {title}
        </h1>
        {!!blurb && (
          <h2 className="text-light bg-semiTransparentDark  mt-4 md:mt-8 lg:text-5xl text-2xl text-center w-screen font-mono text-bold-shadow">
            {blurb}
          </h2>
        )}
      </div>
