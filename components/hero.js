  ...
  return (
    <section className="w-full relative h-threeQuarters md:h-xl">
      <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-full z-20">
        <h1 className="text-center text-5xl mb-1 md:mb-3 text-light md:text-7xl font-hero text-bold-shadow">James DeLay</h1>
        <h2 className="text-center text-3xl text-light md:text-5xl font-hero text-bold-shadow">Software Engineer</h2>
      </div>
